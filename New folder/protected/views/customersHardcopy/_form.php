...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        <div style="float: left; padding-right: 5px;">
            <?php echo $form->checkBox($model,'terms', array('checked'=>'checked', 'required'=>'required')); ?>
        </div>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Sign Me Up' : 'Save'); ?>
	</div>
