...
class Issues extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('date, info, img, url', 'required'),
			array('ID, clicks', 'numerical', 'integerOnly'=>true),
			array('info, img, url', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, date, info, img, url, clicks', 'safe', 'on'=>'search'),
		);
	}
