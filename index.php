...
<header class="p0">
            ...
            <div class="span12">
                <div class="header-block clearfix">
                    <div class="clearfix header-block-pad">
                        <h1 class="brand"><a href="index.html"><img src="images/logo.png" alt=""></a><span></span></h1>
                        <span class="contacts">Call Us Toll Free:  <span>+1 234 567 89 90</span><br>E-mail: <a href="#">sales@BrcketFanatic.com</a></span>
                    </div>
    ...
    <div class="slider">
        <div class="camera_wrap">
            <div data-src="images/join_the_madness_small.png"></div>
        </div>
    </div>
</header>
            ...
            <div class="span12">
                <ul class="thumbnails">
                    <li class="span3">
                        <div class="thumbnail">
                            <div class="caption">
                                    <div class="span1"><h1>23</h1></div>
                                    <div class="span1" style="padding-left: 10px; margin-top: -14px;"><h4>Ways To Win</h4></div>
                            </div>
                            <div class="thumbnail-pad">
                                <p>So many ways to win!  Each round counts!  Leaving so many happy fans.</p>
                    ...
                    <li class="span3">
                        <div class="thumbnail">
                            ...
                            <div class="thumbnail-pad">
                                <p>So many ways to win!  Each round counts!</p>
                                <a href="#" class="btn btn_">more info</a>
                            </div>
                        </div>
                    </li>
                    <li class="span3">
                        <div class="thumbnail">
                            <div class="caption">
                                <h3>AWESOME NEW SWEEPSTAKES FUNDRAISER</h3>
                            </div>
                            <div class="thumbnail-pad">
            ...
            <div class="span8">
                <div class="clearfix cols-1">
                    <div class="span4 left-0">
                        ...
                        <p class="lead">PRESENTING AN AWESOME NEW SWEEPSTAKES FUNDRAISER </p>
                        <figure class="img-indent"><img src="images/home_page/fan_2.png" alt="" class="img-radius"></figure>
                        <ul>
                            <li>#1 Basketball Draw in America</li>
                            <li>Easy Sales!</li>
                            <li>23 Ways to Win!</li>
                            <li>Everyone Loves a Bracket!</li>
                            <li>BracketFanatic Website</li>
                            <li>Keeps Track of Everything!</li>
                            <li>Simple to Run!</li>
                        </ul>
                    </div>
                    <div class="span4">
                        ...
                        <figure class="img-indent"><img src="images/home_page/fan_5.png" alt="" class="img-radius"></figure>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 float">
                ...
                Stylish   &copy;  2012  |   <a href="index-6.html">Privacy Policy</a> More  at <a rel="nofollow" href="http://www.templatemonster.com/category.php?category=0&type=1" target="_blank">TemplateMonster.com</a>
            </div>
        </div>
    </div>
</footer>
