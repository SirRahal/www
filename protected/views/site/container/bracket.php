...
<div>
    ...
    <div class="roster">
        ...
        <?php echo $this->renderPartial('container/round_1_bracket', array('region_ID' => 1)); ?>
        <div class="reagion_title_div_east"><h1 class="reagion_title">East</h1></div>
        <?php echo $this->renderPartial('container/round_1_bracket', array('region_ID' => 3)); ?>
    </div>
    <!--round 3 left-->
    ...
    <div class="roster float_right align_right">
        ...
        <?php echo $this->renderPartial('container/round_1_bracket', array('region_ID' => 2)); ?>
        <div class="reagion_title_div_midwest"><h1 class="reagion_title">Midwest</h1></div>
        <?php echo $this->renderPartial('container/round_1_bracket', array('region_ID' => 4)); ?>
    </div>
    <!--round 3 right-->
