...
<div>
    <?php
        ...
        <div class="mobile_not_float_right button_arrangment">
            ...
            <a class="button tooltip ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="padding: 5px 81px 5px 81px;" href="/index.php/ticket/update/<?php echo $ticket['ID']; ?>" title="Edit This entry up until March 19th 11am EST">Pick My Teams</a>
        </div>
