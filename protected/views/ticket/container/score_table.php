...
<div>
    <?php
        ...
        ?>
        <div><b>School : </b><span><a href="/index.php/school/<?php echo $school_ID; ?>" class="tooltip" title="See how you rank up against other at <?php echo $school; ?>" style="font-size: 1.0em;"><?php echo $school;?></a></span></div>
