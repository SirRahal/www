...
?>
    ...
    <div class="form_container">
        ...
        <div class="row">
            ...
            <?php echo $form->textField($model,'type',array('size'=>58,'maxlength'=>50)); ?>
        ...
        <div class="row">
            ...
            <?php echo $form->textField($model,'part',array('size'=>58,'maxlength'=>50)); ?>
            <?php echo $form->error($model,'part'); ?>
        </div>

        <div class="row">
            <?php echo $form->labelEx($model,'publication'); ?>
            <?php echo $form->textField($model,'publication',array('size'=>58,'maxlength'=>50)); ?>
        ...
        <div class="row">
            ...
            <?php echo $form->textField($model,'copyright',array('size'=>58,'maxlength'=>50)); ?>
    ...
    <div class="form_container">
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'table_of_contents'); ?>
            <?php echo $form->textArea($model,'table_of_contents',array('maxlength'=>1500,'rows'=>4,'cols'=>60)); ?>
            <?php echo $form->error($model,'table_of_contents'); ?>
        </div>
                ...
                <tr>
                    <td>
                        <div class="row">
                            ...
                            <?php echo $form->textField($model,'pages',array('size'=>15,'maxlength'=>15)); ?>
